...
/*
    public static ArrayList<CompanyEntry> getCompanies(int population) {

        ArrayList<CompanyEntry> companyArrayList = new ArrayList<>();

        Random random = new Random();

        while(companyArrayList.size() < population) {
            CompanyEntry company = new CompanyEntry(random.nextInt(Data.name.length));
